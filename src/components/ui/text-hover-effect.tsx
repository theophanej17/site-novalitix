        ...
        >
            <defs>
                ...
                >
                    {hovered && (
                        <>
                            <stop offset="0%" stopColor={"#0071dc"} />
                            <stop offset="25%" stopColor={"#0071dc"} />
                            <stop offset="50%" stopColor={"#fcb239"} />
                            <stop offset="75%" stopColor={"#fcb239"} />
                            <stop offset="100%" stopColor={"#0071dc"} />
                        </>
                    )}
                </linearGradient>
