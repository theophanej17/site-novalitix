                ...
                {PLANS.map((plan) => (
                    <Card
                        ...
                        className={cn(
                            ...
                            plan.name === "Pro" && "border-2 border-[#fcb239]"
                        )}
                    >
                        <CardHeader className={cn(
                            "border-b border-border",
                            plan.name === "Pro" ? "bg-[#fcb239]/[0.07]" : "bg-foreground/[0.03]"
                        )}>
                        ...
                        <CardContent className="pt-6 space-y-4">
                            {plan.features.map((feature, index) => (
                                <div key={index} className="flex items-center gap-2">
                                    <CheckCircleIcon className="text-[#fcb239] w-4 h-4" />
                                    <TooltipProvider>
                        ...
                        <CardFooter className="w-full mt-auto">
                            <Link
                                href={plan.btn.href}
                                style={{ width: "100%" }}
                                className={buttonVariants({ className: plan.name === "Pro" && "bg-[#fcb239] hover:bg-[#fcb239]/80 text-white" })}
                            >
                                {plan.btn.text}
                            </Link>
                        </CardFooter>
                            ...
                            <h5 className="text-3xl font-semibold flex items-end">
                                ...
                                {plan.name !== "Free" && (
                                    <motion.span
                                        ...
                                        className="px-2 py-0.5 ml-2 rounded-md bg-[#fcb239] text-foreground text-sm font-medium"
                                    >
                                        -12%
                                    </motion.span>
                                )}
