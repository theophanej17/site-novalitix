                ...
                <div className="mb-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Card className="p-6 hover:shadow-lg transition-shadow">
                            <div className="flex items-start gap-4">
                                <div className="w-12 h-12 rounded-lg bg-violet-500/10 flex items-center justify-center flex-shrink-0">
                                    <AlertCircleIcon className="w-6 h-6 text-violet-500" />
                                </div>
                                <div>
                        ...
                        <Card className="p-6 hover:shadow-lg transition-shadow">
                            <div className="flex items-start gap-4">
                                <div className="w-12 h-12 rounded-lg bg-violet-500/10 flex items-center justify-center flex-shrink-0">
                                    <TrendingUpIcon className="w-6 h-6 text-violet-500" />
                                </div>
                                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <Card className="p-6 h-full">
                            <div className="w-full h-40 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-lg mb-4 flex items-center justify-center">
                                <BarChart3Icon className="w-16 h-16 text-blue-500" />
                            </div>
                        ...
                        <Card className="p-6 h-full">
                            <div className="w-full h-40 bg-gradient-to-br from-violet-500/20 to-purple-500/20 rounded-lg mb-4 flex items-center justify-center">
                                <PieChartIcon className="w-16 h-16 text-violet-500" />
                            </div>
                        ...
                        <Card className="p-6 h-full">
                            <div className="w-full h-40 bg-gradient-to-br from-fuchsia-500/20 to-pink-500/20 rounded-lg mb-4 flex items-center justify-center">
                                <LineChartIcon className="w-16 h-16 text-fuchsia-500" />
                            </div>
                ...
                <div className="mb-20">
                    ...
                    <Card className="p-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                <h3 className="text-xl font-semibold mb-4 flex items-center gap-2">
                                    <DatabaseIcon className="w-5 h-5 text-violet-500" />
                        ...
                        <div className="mt-8 pt-8 border-t">
                            <h3 className="text-xl font-semibold mb-4 flex items-center gap-2">
                                <FileTextIcon className="w-5 h-5 text-violet-500" />
